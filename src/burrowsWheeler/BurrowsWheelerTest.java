...
public class BurrowsWheelerTest {
   ...
   public static void main(String[] args) {
	   ...
	   bwt.encode(DECODED_INPUT);
       
       System.out.println(String.format("First char: %d, Encoded string: %s", bwt.getFirstChar(), bwt.getEncoded()));
	   
	   System.out.println("Decoded string: " + BurrowsWheeler.decode(bwt.getEncoded(), bwt.getFirstChar()));
